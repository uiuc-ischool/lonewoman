...
(function () {
  ...
  window.ReprintMap = function ReprintMap(containerId, data, options) {
    ...
    RAW.forEach(function (d) {
      d.ts = new Date(d.date + 'T12:00:00Z').getTime();
    });
      ...
      overlay.setProps({
        layers: [
          new deck.ArcLayer({
            id: uid + '_arcs',
            data: arcData,
            getSourcePosition: function (d) { return [d.origin_lng, d.origin_lat]; },
