...
This repository holds the source code and metadata for the [Lone Woman and Last Indians Digital Archive](https://uiuc-ischool.github.io/lonewoman/), a digital collection built with [CollectionBuilder-CSV](https://github.com/CollectionBuilder/collectionbuilder-csv).

The archive collects, transcribes, annotates, and maps 481 nineteenth- and twentieth-century documents relevant to the story of the Lone Woman of San Nicolas Island, best remembered today in the version Scott O'Dell fictionalized in his 1960 novel *Island of the Blue Dolphins*.
...
**[`metadata_building_explainer.md`](site_documentation/metadata_building_explainer.md)**
...
**[`data_relationships_erd_explainer.md`](site_documentation/data_relationships_erd_explainer.md)**
...
**[`article_page_image_gallery.md`](site_documentation/article_page_image_gallery.md)**
...
**[`article_page_transcripts_tropes_entities.md`](site_documentation/article_page_transcripts_tropes_entities.md)**
...
**[`browse_pages_publishers_locations_timeline.md`](site_documentation/browse_pages_publishers_locations_timeline.md)**
...
**[`document_groups_page.md`](site_documentation/document_groups_page.md)**
...
**[`tropes_page.md`](site_documentation/tropes_page.md)**
...
**[`literary_tropes_essay_page.md`](site_documentation/literary_tropes_essay_page.md)**
...
This site is built using [CollectionBuilder-CSV](https://github.com/CollectionBuilder/collectionbuilder-csv), an open source template for creating digital collection and exhibit websites using Jekyll and a metadata CSV, developed by University of Idaho Library's [Digital Initiatives](https://www.lib.uidaho.edu/digital/) and the [Center for Digital Inquiry and Learning](https://cdil.lib.uidaho.edu) (CDIL). Visit the [CollectionBuilder Docs](https://collectionbuilder.github.io/cb-docs/) for details on the underlying template.

## License

CollectionBuilder code is licensed [MIT](LICENSE). This license does not include external dependencies included in the `assets/lib` directory, which are covered by their individual licenses.
This license does *NOT* include any objects, images, or transcripts used in the digital collection, which retain the rights and permissions described in the project's metadata.
